...
interface DriverContactsModalProps {
  contacts?: Contact[];
  onClose: () => void;
}

const DriverContactsModal: React.FC<DriverContactsModalProps> = ({ contacts = [], onClose }) => {
            ...
            contacts.map((c, idx) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1 text-start">
                  ...
                  <p dir="ltr" className="text-xs text-gray-500 font-mono truncate text-start">{c.phone}</p>
                </div>
